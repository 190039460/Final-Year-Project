...
<html lan = "en">
    <head>
        ...
        <title> Team Announcements Page </title>
    ...
    <body>
        <div class = "container">
            ...
            <div class = "content"> 
                <div class = "teamAnnouncements">
                    <h1> TEAM ANNOUNCEMENTS </h1>
                    <div class = "all-teamAnnouncements">
                        <div class = "teamAnnouncement-container">
                            <img src = "images/TeamAnnouncement1.png">
                            <div class = "teamAnnouncement-info">
                                <h4 class = "teamAnnouncement-title"> General Info / Team Handbook </h4>
                                <a class = "teamAnnouncement-btn" href = "teamannouncement1.php"> View Announcement </a>
                            </div>
                        </div>
                        <div class = "teamAnnouncement-container">
                            <img src = "images/TeamAnnouncement2.png">
                            <div class = "teamAnnouncement-info">
                                <h4 class = "teamAnnouncement-title"> Rules </h4>
                                <a class = "teamAnnouncement-btn" href = "teamannouncement2.php"> View Announcement </a>
                            </div>
                        </div>
                        <div class = "teamAnnouncement-container">
                            <img src = "images/TeamAnnouncement3.png">
                            <div class = "teamAnnouncement-info">
                                <h4 class = "teamAnnouncement-title"> Key Dates </h4>
                                <a class = "teamAnnouncement-btn" href = "teamannouncement3.php"> View Announcement </a>
                            </div>
                        </div>
                        <div class = "teamAnnouncement-container">
                            <img src = "images/TeamAnnouncement4.png">
                            <div class = "teamAnnouncement-info">
                                <h4 class = "teamAnnouncement-title"> Register Your Team </h4>
                                <a class = "teamAnnouncement-btn" href = "teamannouncement4.php"> View Announcement </a>
                            </div>
                        </div>
                        <div class = "teamAnnouncement-container">
                            <img src = "images/TeamAnnouncement5.png">
                            <div class = "teamAnnouncement-info">
                                <h4 class = "teamAnnouncement-title"> Forms and Documents </h4>
                                <a class = "teamAnnouncement-btn" href = "teamannouncement5.php"> View Announcement </a>
                            </div>
                        </div>
                        <div class = "teamAnnouncement-container">
                            <img src = "images/TeamAnnouncement6.png">
                            <div class = "teamAnnouncement-info">
                                <h4 class = "teamAnnouncement-title"> 2025 Teams </h4>
                                <a class = "teamAnnouncement-btn" href = "teamannouncement6.php"> View Announcement </a>
                            </div>
                        </div>
                    </div>
                </div>
