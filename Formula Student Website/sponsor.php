    ...
    <body>
        <div class = "container">
            ...
            <div class = "content"> 
                <div class = "sponsor">
                    <h1> SPONSOR </h1>
                    <img src = "images/AMK logo.png">
                    <h2> Aston Formula Student Sponsors </h2>
                    <br>
                    <p> The Formula Student program is mainly supported by Aston University by both providing the facilities and funding, but it would not survive without the help of our sponsorship partnerships with 
                        organisations outside the University. </p>
                    <br>
                    <p> Over the years Aston Formula Student has formed lasting partnerships that have not only benefitted the students but also the companies themselves. These partnerships can come in the form of extra 
                        funding or technical support. </p>
                    <br>
                    <p> If you like to learn more about our sponsor here is the link below. </p>
                    <a href = "https://www.amk-motion.com/en/" target = "_blank" rel = "noopener no-referrer"> AMK Website </a>
                </div>
            </div>
            <footer>  
