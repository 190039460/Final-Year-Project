            ...
            <div class = "content"> 
                <div class = "meetTeam">
                    ...
                    <div class = "profileContainer">
                        <div class = "profiles">
                            <div class = "profile">
                                <img src = "images/Formula Student Driver.jpg" class ="profile-img">
                                <h3 class = "user-name"> Driver </h3>
                                <h5> Aston University </h5>
                                <p> The driver representing Aston University. </p>
                            </div>
                        </div>
                        <div class = "profiles">
                            <div class = "profile">
                                <img src = "images/Formula Student Design Team.jpg" class ="profile-img">
                                <h3 class = "user-name"> Design Team </h3>
                                <h5> Aston University </h5>
                                <p> The design team creating concepts of the race car. </p>
                            </div>
                        </div>
                        <div class = "profiles">
                            <div class = "profile">
                                <img src = "images/Formula Student Engineers.jpg" class ="profile-img">
                                <h3 class = "user-name"> Engineers </h3>
                                <h5> Aston University </h5>
                                <p> The engineering team building the race car. </p>
                            </div>
                        </div>
                    </div>
                </div>
