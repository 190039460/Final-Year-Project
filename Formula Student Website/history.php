    ...
    <body>
        <div class = "container">
            ...
            <div class = "content"> 
                <div class = "history">
                    <h1> HISTORY </h1>
                    <h2> Timeline of the Formula Race Car </h2>
                    <p> The beginning of Formula Student Race Car Event started way back at 2003, and all the way to 2022 was the most recent date of the last Formula Race Car Event Aston University took part in. </p>
                    <img src = "images/TimelineofF1Cars.PNG">
