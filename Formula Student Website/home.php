...
<html lan = "en">
    ...
    <body>
        <div class = "container">
            ...
            <div class = "content"> 
                <div class = "home">
                    <h1> WELCOME TO ASTON FORMULA <br> STUDENT WEBSITE </h1>
                    <p> If you are interested in the Formula Student Event or would like to learn more, <br> visit 
                        the official Formula Student Website by clicking the button below. </p>
                    <a href = "https://www.imeche.org/events/formula-student" target = "_blank" rel = "noopener no-referrer"> <button type = "button"> <span></span> Formula Student Website </button> </a>
                </div>
            </div>
            <footer>  
