                ...
                <div class = "news">
                    ...
                    <div class = "all-news">
                        <div class = "news-container">
                            ...
                            <div class = "news-info">
                                <h4 class = "news-title"> Formula Student
                                    Start testing your FSAI car today using Carmaker, 
                                    Ansys AVx & AWS for free </h4>
                                <a class = "news-btn" href = "news1.php"> View News </a>
                            </div>
                        </div>
                        <div class = "news-container">
                            ...
                            <div class = "news-info">
                                <h4 class = "news-title"> Formula Student
                                    RS Build Fund for Formula Student 2025 teams open </h4>
                                <a class = "news-btn" href = "news2.php"> View News </a>
                            </div>
                        </div>
                        <div class = "news-container">
                            <img src = "images/News3.png">
                            <div class = "news-info">
                                <h4 class = "news-title"> Formula Student 2025 registration now open </h4>
                                <a class = "news-btn" href = "news3.php"> View News </a>
                            </div>
                        </div>
                        <div class = "news-container">
                            <img src = "images/News4.png">
                            <div class = "news-info">
                                <h4 class = "news-title"> Formula Student 2025 rules now available </h4>
                                <a class = "news-btn" href = "news4.php"> View News </a>
                            </div>
                        </div>
                        <div class = "news-container">
                            <img src = "images/News5.png">
                            <div class = "news-info">
                                <h4 class = "news-title"> Secure a financial award for Formula Student 2025 </h4>
                                <a class = "news-btn" href = "news5.php"> View News </a>
                            </div>
                        </div>
                        <div class = "news-container">
                            <img src = "images/News6.png">
                            <div class = "news-info">
                                <h4 class = "news-title"> Where are they now? Harry Graff, Bentley Motors Placement Student </h4>
                                <a class = "news-btn" href = "news6.php"> View News </a>
                            </div>
                        </div>
                    </div>
                </div>
