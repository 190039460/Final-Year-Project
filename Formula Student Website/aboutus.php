                    ...
                    <div class = "aboutUsContainer">
                        <section class = "about">
                            ...
                            <div class = "aboutUsContent">
                                ...
                                <p> Formula Student is an international competition run by the Institute of Mechanical Engineers (IMechE). It promotes careers and excellence in engineering, by challenging teams of university students to 
                                    design, build, develop, market and compete with a small single seater racing car. Aston University has been competing in the Formula Student competition since 2002, with each year seeing new ideas 
                                    and technologies incorporated into the car. </p>
                                <a href = "http://events.imeche.org/formula-student/" class = "learn-more" target = "_blank" rel = "noopener no-referrer"> Learn More </a>
                            </div>
                        </section>
                    </div>
                </div>
