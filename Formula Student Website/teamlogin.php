        ...
        <div class = "container">
            <nav> 
                <ul>
                    ...
                    <li><a href = "teamlogin.php"> Team Login </a></li>
                    <li><a href = "teamsignup.php"> Team Signup </a></li>
                </ul>
            </nav>
            <div class = "content"> 
                <div class = "teamLogin">
                    ...
                    <div class = "login">
                        ...
                        <form>
                            <label> Email </label>
                            <input type = "email" placeholder = "Enter Aston Email">
                            <label> Password </label>
                            <input type = "password" placeholder = "Enter Password">
                            <input type = "button" value = "Login">
                        </form>
                    </div>
                    <p> Not have an account? <a href = "teamsignup.php"> Sign Up here </a> </p>
                </div>
            </div>
            <footer>  
